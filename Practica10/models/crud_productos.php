...
class DatosProductos extends Conexion{
	...
	public function registroProductoModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombreProd, descProduc, BuyPrice, SalePrice, Proce) VALUES (:nombre,:descu,:pricebuy,:pricesale,:price)");	

		#bindParam() Vincula una variable de PHP a un parámetro de sustitución con nombre o de signo de interrogación correspondiente de la sentencia SQL que fue usada para preparar la sentencia.

		$stmt->bindParam(":nombre", $datosModel["nombre"], PDO::PARAM_STR);
		$stmt->bindParam(":descu", $datosModel["desc"], PDO::PARAM_STR);
		$stmt->bindParam(":pricebuy", $datosModel["pricebuy"], PDO::PARAM_STR);
		$stmt->bindParam(":pricesale", $datosModel["pricesale"], PDO::PARAM_STR);
