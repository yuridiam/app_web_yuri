...
<form style="font-family: Arial; width: 50%; margin-left: 350px">
	<h1 style="font-weight: bold">Entradas</h1>
	<hr>
	<br>
	<a href="index.php?action=registrarentrada"><input type="button" name="agregarEntrada" class="button tiny" style="background-color: #00715F" value="Agregar Entrada"></a>
	<br>
	<br>
