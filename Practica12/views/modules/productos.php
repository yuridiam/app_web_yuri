...
<form style="font-family: Arial; width: 50%; margin-left: 350px">
	...
	<hr>
	<br>
	<a href="index.php?action=registrarproducto"><input type="button" name="agregarProducto" class="button tiny" style="background-color: #00715F" value="Agregar Producto"></a>
	<br>
	<br>
