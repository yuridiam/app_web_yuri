...
<div style="background-color: #E8ECEF ">
	<div class="jumbotron" >
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <a href="index.php?action=nuevasesion2"><button type="button" class="btn btn-primary btn-sm" style="margin-top: 30px; margin-left: 440px; background-color: #0087FF">Registrar Sesión</button></a>
        </div>
      </div>
			<hr>
			<br>
