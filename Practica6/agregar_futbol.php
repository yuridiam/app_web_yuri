<?php 
  ...
  if(isset($_POST["agregar"])){
    $dorso = $_POST["dorso"];
    //funcion que comprueba si ya existe un futbolista con el mismo numero de dorso
    $d = dorso_exists($dorso,1);
    //si existe un futbolista con el mismo numero de dorso genera un mensaje
    if($d==1){
      echo "<script type='text/javascript'>
            alert('Ya existe un futbolista con el mismo número de dorso');
          </script>";
    }else{
      //toma los valores de las cajas
        ...
        $r = add(1, $dorso, $nombre, $pos, $carrera, $correo);
        if($r){
          //genera un mensaje de exito
          echo "<script type='text/javascript'>
            alert('Futbolista almacenado');
          </script>";
        }
    }
  }
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-9 columns">
        <h2 style="font-weight: bold">Agregar futbolista</h2>
        <hr>
