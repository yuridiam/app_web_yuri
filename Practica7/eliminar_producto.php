...
<script type="text/javascript">
	...
	var id = getUrlVars();
	var id2 = ""+id["id"];
	//se almacena la respuesta del usuario con la confirmacion
	var c = confirm("¿Está seguro que desea eliminar este producto?");
	if(c){
		//se redireciona con la respuesta del usuario y el mismo id del registro
		location.href="eliminar_producto.php?id="+id2+"&b=1";
	}else{
