<?php 
  ...
  if($cont==2){
    ...
    $r = modificar_producto($id, $_POST["nombre"],$_POST["precio"]);
    if($r){
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-9 columns">
        <h2 style="font-weight: bold">Modificar Producto</h2>
        <hr>
          ...
          <section class="section">
            <div class="content" data-slug="panel1">
              ...
              <form id="formu" method="post" name="formu">
                ...
                <input type="text" name="precio" placeholder="Precio unitario" value="<?php echo $b['preciounitario']?>" required>
              ...
              <script type="text/javascript">
                  ...
                  function a(){
                    ...
                    var c = confirm("¿Está seguro que desea modificar este producto?");
                    if(c){
                      ...
                      location.href="modificar_producto.php?id="+id2;
                    }
                  }
            </script>
          </div>
