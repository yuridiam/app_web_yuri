  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-12 columns">
        ...
        <hr>
        <a href="nuevo_producto.php" class="button radius tiny secondary" style="background-color: green; margin-left: 890px; color:white">Agregar</a>
          ...
          <section class="section">
            <div class="content" data-slug="panel1">
              ...
              <table>
                ...
                <tbody>
                	<?php
                    //recoje cada atributo por cada fila
                  ...
                  <tr>
                    ...
                    <td><a href="modificar_producto.php?id=<?php echo $fila['id']; ?>" class="button radius tiny secondary" style="background-color: blue; color:white">Modificar</a>&nbsp;<a href="eliminar_producto.php?id=<?php echo $fila['id']; ?>" class="button radius tiny secondary" style="background-color: red; color:white" >Eliminar</a></td>
                  </tr>
                  <?php
                		}
                	?>
